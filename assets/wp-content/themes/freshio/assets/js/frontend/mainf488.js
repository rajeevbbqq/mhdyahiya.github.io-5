...
handleWindow();blog_style();login_dropdown();$(document).ready(function(){cross_sells_carousel();});$(window).on('resize',function(){handleWindow();});$(window).on('elementor/frontend/init',()=>{svg_iconbox();});})(jQuery);